...
.method private generateDerivedKey(II)[B
    ...
    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B
    ...
    iget p1, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    iget-object v4, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B

    array-length v4, v4

    iget v5, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I
    ...
    iget-object v5, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B

    iget-object v6, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B
    ...
    :cond_2
    iget-object v4, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B
    ...
    iget v4, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    iget-object v5, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B

    array-length v5, v5

    iget v6, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I
    ...
    iget-object v6, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B
    ...
    iget v4, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
    ...
    iget v6, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I

    new-array v6, v6, [B

    iget-object v7, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;
    ...
    :goto_4
    iget v8, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->iterationCount:I

    if-eq v7, v8, :cond_5

    iget-object v8, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;
    ...
    iget v9, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I
    ...
    invoke-direct {p0, v5, v9, p1}, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->adjust([BI[B)V
    ...
    iget v8, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
