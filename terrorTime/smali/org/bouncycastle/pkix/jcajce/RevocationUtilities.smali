...
.method static checkCRLsNotEmpty(Ljava/util/Set;Ljava/lang/Object;)V
    ...
    new-instance p0, Lorg/bouncycastle/pkix/jcajce/CRLNotFoundException;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/pkix/jcajce/CRLNotFoundException;-><init>(Ljava/lang/String;)V
...
.method protected static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/pkix/jcajce/CertStatus;)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/pkix/jcajce/RevocationUtilities;->getSerialNumber(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    invoke-static {v0, p1}, Lorg/bouncycastle/pkix/jcajce/RevocationUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :goto_2
    invoke-virtual {p3, p0}, Lorg/bouncycastle/pkix/jcajce/CertStatus;->setCertStatus(I)V

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object p0

    invoke-virtual {p3, p0}, Lorg/bouncycastle/pkix/jcajce/CertStatus;->setRevocationDate(Ljava/util/Date;)V
