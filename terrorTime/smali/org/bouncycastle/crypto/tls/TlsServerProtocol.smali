...
.method protected handleHandshakeMessage(SLjava/io/ByteArrayInputStream;)V
    ...
    iput-short v7, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->connection_state:S
    ...
    invoke-static {p2}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->readSupplementalDataMessage(Ljava/io/ByteArrayInputStream;)Ljava/util/Vector;
    ...
    :goto_1
    invoke-virtual {p0, p2}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->processFinishedMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    iput-short v8, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->connection_state:S
    ...
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->sendCertificateMessage(Lorg/bouncycastle/crypto/tls/Certificate;)V
    ...
    iput-short v2, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->connection_state:S
...
.method protected receiveClientHelloMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-interface {p1}, Lorg/bouncycastle/crypto/tls/TlsServer;->requiresExtendedMasterSecret()Z
