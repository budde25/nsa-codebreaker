...
.field private handshakeHashUpdater:Lorg/bouncycastle/util/io/SimpleOutputStream;
...
.field private readSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;
...
.field private writeSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;
...
.method constructor <init>(Lorg/bouncycastle/crypto/tls/TlsProtocol;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->readSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;

    new-instance v1, Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;

    invoke-direct {v1, v0}, Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;-><init>(Lorg/bouncycastle/crypto/tls/RecordStream$1;)V

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->handshakeHashUpdater:Lorg/bouncycastle/util/io/SimpleOutputStream;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->readCompression:Lorg/bouncycastle/crypto/tls/TlsCompression;
...
.method static synthetic access$100(Lorg/bouncycastle/crypto/tls/RecordStream;)Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;
    .locals 0

    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->handshakeHash:Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;
...
.method checkRecordHeader([B)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readUint8([BI)S
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->restrictReadVersion:Z
    ...
    invoke-static {p1, v2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readVersionRaw([BI)I
    ...
    :cond_1
    invoke-static {p1, v2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readVersion([BI)Lorg/bouncycastle/crypto/tls/ProtocolVersion;
    ...
    :cond_2
    invoke-virtual {v0, v2}, Lorg/bouncycastle/crypto/tls/ProtocolVersion;->equals(Lorg/bouncycastle/crypto/tls/ProtocolVersion;)Z
    ...
    invoke-static {p1, v0, v1}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkLength(IIS)V
...
.method decodeAndVerify(SLjava/io/InputStream;I)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->readSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;

    const/16 p3, 0xa

    invoke-virtual {p2, p3}, Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;->nextValue(S)J
    ...
    invoke-interface/range {v0 .. v6}, Lorg/bouncycastle/crypto/tls/TlsCipher;->decodeCiphertext(JS[BII)[B
...
.method getHandshakeHashUpdater()Ljava/io/OutputStream;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->handshakeHashUpdater:Lorg/bouncycastle/util/io/SimpleOutputStream;
...
.method readRecord()Z
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->ciphertextLimit:I

    const/16 v4, 0x16

    invoke-static {v0, v3, v4}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkLength(IIS)V
...
.method receivedReadCipherSpec()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->readSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;
...
.method sentWriteCipherSpec()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;
...
.method setPlaintextLimit(I)V
    ...
    iget p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->plaintextLimit:I

    add-int/lit16 p1, p1, 0x400

    iput p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->compressedLimit:I

    iget p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->compressedLimit:I
...
.method writeRecord(S[BII)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkType(SS)V

    iget v1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->plaintextLimit:I

    invoke-static {p4, v1, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    :cond_2
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeCompression:Lorg/bouncycastle/crypto/tls/TlsCompression;

    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->buffer:Ljava/io/ByteArrayOutputStream;

    invoke-interface {v2, v3}, Lorg/bouncycastle/crypto/tls/TlsCompression;->compress(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v2

    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeSeqNo:Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;

    invoke-virtual {v3, v0}, Lorg/bouncycastle/crypto/tls/RecordStream$SequenceNumber;->nextValue(S)J
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeCipher:Lorg/bouncycastle/crypto/tls/TlsCipher;
    ...
    invoke-interface/range {v4 .. v10}, Lorg/bouncycastle/crypto/tls/TlsCipher;->encodePlaintext(JS[BII)[B
    ...
    invoke-static {p2, p4, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    iget p4, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->ciphertextLimit:I

    invoke-static {p3, p4, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeVersion:Lorg/bouncycastle/crypto/tls/ProtocolVersion;

    invoke-static {p1, p3, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeVersion(Lorg/bouncycastle/crypto/tls/ProtocolVersion;[BI)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->output:Ljava/io/OutputStream;
