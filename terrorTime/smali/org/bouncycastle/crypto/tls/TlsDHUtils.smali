...
.field static final draft_ffdhe2432:Lorg/bouncycastle/crypto/params/DHParameters;
...
.field static final draft_ffdhe3072:Lorg/bouncycastle/crypto/params/DHParameters;
...
.field static final draft_ffdhe4096:Lorg/bouncycastle/crypto/params/DHParameters;
...
.field static final draft_ffdhe6144:Lorg/bouncycastle/crypto/params/DHParameters;
...
.field static final draft_ffdhe8192:Lorg/bouncycastle/crypto/params/DHParameters;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->EXT_negotiated_ff_dhe_groups:Ljava/lang/Integer;
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->fromSafeP(Ljava/lang/String;)Lorg/bouncycastle/crypto/params/DHParameters;

    move-result-object v0

    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe2432:Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe3072:Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe4096:Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe6144:Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe8192:Lorg/bouncycastle/crypto/params/DHParameters;
...
.method public static addNegotiatedDHEGroupsClientExtension(Ljava/util/Hashtable;[S)V
    ...
    sget-object v0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->EXT_negotiated_ff_dhe_groups:Ljava/lang/Integer;

    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->createNegotiatedDHEGroupsClientExtension([S)[B
...
.method public static addNegotiatedDHEGroupsServerExtension(Ljava/util/Hashtable;S)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->createNegotiatedDHEGroupsServerExtension(S)[B
...
.method public static containsDHECipherSuites([I)Z
    ...
    invoke-static {v2}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->isDHECipherSuite(I)Z
...
.method private static fromSafeP(Ljava/lang/String;)Lorg/bouncycastle/crypto/params/DHParameters;
    .locals 3

    invoke-static {p0}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->fromHex(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    sget-object v2, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->TWO:Ljava/math/BigInteger;

    invoke-direct {v1, p0, v2, v0}, Lorg/bouncycastle/crypto/params/DHParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static generateEphemeralServerKeyExchange(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/params/DHParameters;Ljava/io/OutputStream;)Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->writeDHParameters(Lorg/bouncycastle/crypto/params/DHParameters;Ljava/io/OutputStream;)V
...
.method public static getNegotiatedDHEGroupsClientExtension(Ljava/util/Hashtable;)[S
    ...
    :cond_0
    invoke-static {p0}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->readNegotiatedDHEGroupsClientExtension([B)[S
...
.method public static getNegotiatedDHEGroupsServerExtension(Ljava/util/Hashtable;)S
    ...
    :cond_0
    invoke-static {p0}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->readNegotiatedDHEGroupsServerExtension([B)S
...
.method public static getParametersForDHEGroup(S)Lorg/bouncycastle/crypto/params/DHParameters;
    .locals 1
    ...
    :cond_0
    sget-object p0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe8192:Lorg/bouncycastle/crypto/params/DHParameters;

    return-object p0

    :cond_1
    sget-object p0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe6144:Lorg/bouncycastle/crypto/params/DHParameters;

    return-object p0

    :cond_2
    sget-object p0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe4096:Lorg/bouncycastle/crypto/params/DHParameters;

    return-object p0

    :cond_3
    sget-object p0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe3072:Lorg/bouncycastle/crypto/params/DHParameters;

    return-object p0

    :cond_4
    sget-object p0, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->draft_ffdhe2432:Lorg/bouncycastle/crypto/params/DHParameters;
...
.method public static readDHParameters(Ljava/io/InputStream;)Lorg/bouncycastle/crypto/params/DHParameters;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v1, v0, p0}, Lorg/bouncycastle/crypto/params/DHParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static receiveDHParameters(Lorg/bouncycastle/crypto/tls/TlsDHVerifier;Ljava/io/InputStream;)Lorg/bouncycastle/crypto/params/DHParameters;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->readDHParameters(Ljava/io/InputStream;)Lorg/bouncycastle/crypto/params/DHParameters;

    move-result-object p1

    invoke-interface {p0, p1}, Lorg/bouncycastle/crypto/tls/TlsDHVerifier;->accept(Lorg/bouncycastle/crypto/params/DHParameters;)Z
...
.method public static writeDHParameters(Lorg/bouncycastle/crypto/params/DHParameters;Ljava/io/OutputStream;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0, p1}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->writeDHParameter(Ljava/math/BigInteger;Ljava/io/OutputStream;)V
