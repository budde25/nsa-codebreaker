...
.method public getSelectedCipherSuite()I
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->getUsableSignatureAlgorithms(Ljava/util/Vector;)Ljava/util/Vector;
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->offeredCipherSuites:[I
    ...
    invoke-static {v4}, Lorg/bouncycastle/crypto/tls/TlsECCUtils;->isECCCipherSuite(I)Z
    ...
    :cond_0
    iget-object v5, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->serverVersion:Lorg/bouncycastle/crypto/tls/ProtocolVersion;

    invoke-static {v4, v5}, Lorg/bouncycastle/crypto/tls/TlsUtils;->isValidCipherSuiteForVersion(ILorg/bouncycastle/crypto/tls/ProtocolVersion;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-static {v4, v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->isValidCipherSuiteForSignatureAlgorithms(ILjava/util/Vector;)Z

    move-result v5

    if-eqz v5, :cond_1

    iput v4, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->selectedCipherSuite:I
...
.method public notifyOfferedCipherSuites([I)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->offeredCipherSuites:[I
