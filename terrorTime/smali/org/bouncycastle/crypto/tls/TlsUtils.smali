...
.method static PRF_legacy([B[B[BI)[B
    ...
    invoke-static {v0, v2, p2, p0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->hmac_hash(Lorg/bouncycastle/crypto/Digest;[B[B[B)V

    invoke-static {v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->createHash(S)Lorg/bouncycastle/crypto/Digest;

    move-result-object v0

    invoke-static {v0, v3, p2, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->hmac_hash(Lorg/bouncycastle/crypto/Digest;[B[B[B)V
...
.method public static getUsableSignatureAlgorithms(Ljava/util/Vector;)Ljava/util/Vector;
    ...
    invoke-static {}, Lorg/bouncycastle/crypto/tls/TlsUtils;->getAllSignatureAlgorithms()Ljava/util/Vector;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;->getSignature()S
...
.method static hmac_hash(Lorg/bouncycastle/crypto/Digest;[B[B[B)V
    ...
    invoke-virtual {v0, v5, v3, v6}, Lorg/bouncycastle/crypto/macs/HMac;->update([BII)V

    invoke-virtual {v0, v1, v3}, Lorg/bouncycastle/crypto/macs/HMac;->doFinal([BI)I

    array-length v5, v1

    invoke-virtual {v0, v1, v3, v5}, Lorg/bouncycastle/crypto/macs/HMac;->update([BII)V

    array-length v5, p2

    invoke-virtual {v0, p2, v3, v5}, Lorg/bouncycastle/crypto/macs/HMac;->update([BII)V

    invoke-virtual {v0, v2, v3}, Lorg/bouncycastle/crypto/macs/HMac;->doFinal([BI)I
...
.method public static isValidCipherSuiteForSignatureAlgorithms(ILjava/util/Vector;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->getKeyExchangeAlgorithm(I)I
    ...
    :goto_1
    invoke-static {p0}, Lorg/bouncycastle/util/Shorts;->valueOf(S)Ljava/lang/Short;
...
.method static trackHashAlgorithms(Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;Ljava/util/Vector;)V
    ...
    invoke-static {v1}, Lorg/bouncycastle/crypto/tls/HashAlgorithm;->isRecognized(S)Z
