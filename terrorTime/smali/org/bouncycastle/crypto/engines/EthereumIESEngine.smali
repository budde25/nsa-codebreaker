...
.method private decryptBlock([BII)[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->V:[B
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->mac:Lorg/bouncycastle/crypto/Mac;
    ...
    invoke-virtual {p0, v4}, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->getLengthTag([B)[B
    ...
    invoke-interface {v8, v2, v1, v10}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v2, v8}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->mac:Lorg/bouncycastle/crypto/Mac;

    iget-object v8, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->IV:[B

    array-length v9, v8

    invoke-interface {v2, v8, v1, v9}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    :cond_7
    invoke-virtual {p1, v0, v3}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->doFinal([BI)I
...
.method private encryptBlock([BII)[B
    ...
    invoke-interface {v4, v2, v1, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v2, v4}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->mac:Lorg/bouncycastle/crypto/Mac;

    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->IV:[B

    array-length v5, v4

    invoke-interface {v2, v4, v1, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
