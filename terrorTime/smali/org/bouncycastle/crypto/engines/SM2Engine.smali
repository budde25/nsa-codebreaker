...
.method private decrypt([BII)[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->mode:Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;

    sget-object v5, Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;->C1C3C2:Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;
    ...
    invoke-static {p1, v4, p3, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-direct {p0, v3, v1, p3}, Lorg/bouncycastle/crypto/engines/SM2Engine;->kdf(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/ECPoint;[B)V
    ...
    invoke-direct {p0, v4, v5}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/ECFieldElement;)V

    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->digest:Lorg/bouncycastle/crypto/Digest;

    array-length v5, p3

    invoke-interface {v4, p3, v2, v5}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, v4, v1}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/ECFieldElement;)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v1, v3, v2}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I

    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->mode:Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;

    sget-object v4, Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;->C1C3C2:Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;
...
.method private encrypt([BII)[B
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;->ordinal()I
    ...
    invoke-static {v4, v0, v1}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B)[B
    ...
    :cond_1
    invoke-static {v4, v1, v0}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B)[B
