...
.method private hash([BI)[B
    ...
    invoke-virtual {v4, v1, v2, v5}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    array-length v1, p1

    invoke-virtual {v4, p1, v2, v1}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    invoke-virtual {v4, v3, v2}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->doFinal([BI)I
    ...
    invoke-virtual {v4, v3, v2, v7}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    invoke-virtual {v4, v3, v2}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->doFinal([BI)I

    invoke-static {v3, v2, v0, v6, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {p1, v3, v2, p2}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    invoke-virtual {p1, v0, v6}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->doFinal([BI)I
