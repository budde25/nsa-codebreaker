...
.method protected deriveKey(I[B[B)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    :goto_0
    :try_start_0
    iget-object p3, p0, Lorg/bouncycastle/crypto/kems/ECIESKeyEncapsulation;->kdf:Lorg/bouncycastle/crypto/DerivationFunction;

    new-instance v0, Lorg/bouncycastle/crypto/params/KDFParameters;

    const/4 v2, 0x0

    invoke-direct {v0, p2, v2}, Lorg/bouncycastle/crypto/params/KDFParameters;-><init>([B[B)V

    invoke-interface {p3, v0}, Lorg/bouncycastle/crypto/DerivationFunction;->init(Lorg/bouncycastle/crypto/DerivationParameters;)V
    ...
    invoke-interface {p3, p1, v1, v0}, Lorg/bouncycastle/crypto/DerivationFunction;->generateBytes([BII)I
