...
.method private static hmac_hash(Lorg/bouncycastle/crypto/Mac;[B[B[B)V
    ...
    invoke-interface {p0, v5, v3, v6}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    invoke-interface {p0, v1, v3}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I

    array-length v5, v1

    invoke-interface {p0, v1, v3, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    array-length v5, p2

    invoke-interface {p0, p2, v3, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    invoke-interface {p0, v2, v3}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I
